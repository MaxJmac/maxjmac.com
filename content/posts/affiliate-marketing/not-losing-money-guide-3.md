...
- 如何移除CPA Trial?
  ...
  当你达到300$以上的花费并且当时的Score在90%以上时，联系右下角的在线支持，询问是否可以移除Trial，可以他就会给你移除，不行你就等过一两天再问，注意每次询问时你的Score必须在90%以上才有意义，否则他会说你的Performance不足而拒绝你。
...
跑的好的小伙伴已经不是不亏钱了，已经开始赚钱了。早点把CPA Trial变成CPA，后面就是轻松工作就能带来收益。所以前期要懂得让利，尽快把CPA Trial变成CPA。
